...
check(pkg.version === '0.8.7', 'Коммерческая сборка должна иметь версию 0.8.7');
check(build.includes("APP_BUILD = 'v0.8.7'"), 'APP_BUILD должен совпадать с v0.8.7');
...
console.log('\nCommercial release smoke passed: v0.8.7 shell, recovery, React Core, first-player guidance and hybrid media are present.');
