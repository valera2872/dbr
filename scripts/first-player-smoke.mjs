...
check(['0.8.8','0.8.9','0.9.0','0.9.1','0.9.2','0.9.3','0.9.4','0.9.5','0.9.6','0.9.7','0.9.8','0.9.9','0.10.0'].includes(pkg.version), 'First-player fixes должны сохраняться в релизах 0.8.8+');
