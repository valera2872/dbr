...
check(['0.8.8','0.8.9','0.9.0','0.9.1','0.9.2','0.9.3','0.9.4','0.9.5','0.9.6','0.9.7','0.9.8','0.9.9'].includes(pkg.version), 'Interrogation guidance должна сохраняться в релизах 0.8.8+');
