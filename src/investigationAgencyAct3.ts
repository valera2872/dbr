...
function identityLeadMarkup(state: InvestigationSnapshot): string {
  ...
  return `<section class="evidence-led-panel" data-evidence-led-mode="identity-lead" aria-label="Проверка неизвестного участника старого дела">
    ...
    <p class="evidence-led-intro">Архив доказал существование B-17, старый спор о безопасности и передачу оригинала семье Белова. Но в цепочке хранения оригинала остаётся пробел. Не назначайте подозреваемого заранее — восстановите, <strong>кто мог сохранить носитель до встречи с Ильёй</strong>.</p>
